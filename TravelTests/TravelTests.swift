...
final class TravelTests: XCTestCase {
    ...
    func testNearestStationsService() async throws {
        let service = NearestStationsService(client: try getClient(), apikey: TravelServiceConstants.apiKey)
    ...
    func testStationsListService() async throws {
        let service = StationsListService(client: try getClient(), apikey: TravelServiceConstants.apiKey)
        let stations = try await service.getStationsList()
        XCTAssertNotNil(stations.countries)
    }

    func testCityService() async throws {
        let service = CityService(client: try getClient(), apikey: TravelServiceConstants.apiKey)
    ...
    func testCarrierService() async throws {
        ...
        let service = CarrierService(client: try getClient(), apikey: TravelServiceConstants.apiKey)
    ...
    func testCopyrightService() async throws {
        let service = CopyrightService(client: try getClient(), apikey: TravelServiceConstants.apiKey)
        let copyright = try await service.getCopyright()
        XCTAssertEqual(copyright.copyright?.text?.contains("Яндекс.Расписания"), true)
    }

    func testRouteService() async throws {
        let service = RouteService(client: try getClient(), apikey: TravelServiceConstants.apiKey)
    ...
    func testScheduleService() async throws {
        let service = ScheduleService(client: try getClient(), apikey: TravelServiceConstants.apiKey)
    ...
    func testSearchRoutesService() async throws {
        let service = SearchRoutesService(client: try getClient(), apikey: TravelServiceConstants.apiKey)
